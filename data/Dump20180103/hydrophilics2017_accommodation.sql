...
CREATE TABLE `accommodation` (
  ...
  CONSTRAINT `accommodation_ibfk_1` FOREIGN KEY (`PlaceName`) REFERENCES `place` (`PlaceName`)
...
INSERT INTO `accommodation` VALUES ('AshokaHotel',30),('LeMeridien',20),('Shangri-La',20);
